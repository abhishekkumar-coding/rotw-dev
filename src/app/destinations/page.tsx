...
const Destinations: React.FC = () => {
    ...
    return (
        <div className="w-full">
            ...
            <div className="w-full max-w-6xl mx-auto mt-16 md:mt-0 py-6 flex flex-col items-center bg-[#292B5B12]"> <h1 className="text-[#292B5B] font-extrabold text-xl md:text-3xl">Top <span className="text-[#FF0000]">Destinations</span> to Visit in Russia</h1></div>
            <div className="w-full mx-auto flex flex-col items-center justify-between md:flex-row max-w-6xl  bg-[#292B5B12] pb-10 md:px-20">
            ...
            <div className="w-full mx-auto flex flex-col items-center justify-between md:flex-row max-w-6xl  bg-[#292B5B12] py-4 md:px-20">
                <div className="w-full md:w-1/2 px-6 flex flex-col items-center md:items-start space-y-5 justify-center py-6">
                    {/* Heading for large screens */}
                    <h1 className="text-xl text-left hidden md:block md:text-left md:mb-0 text-[#292B5B] md:text-3xl font-bold underline decoration-[#FF0000]">
                        SOCHI
